...
ggplot(df_sr_c_br_str, aes(x = CSSA, y = Fungi, color = siteID)) +
  geom_point() +
  stat_smooth(method = "lm", formula = y ~ x) +
  labs(x = "Carbon Stock Stand Alive [ton]", y = "Fungi obs. rich. [alpha div.]")
...
ggplot(df_sr_c_br_str, aes(x = CSLD, y = Fungi)) +
  geom_point() +
  stat_smooth(method = "lm", formula = y ~ x) +
  labs(x = "Carbon Stock Lying Dead [ton]", y = "Fungi obs. rich. [alpha div.]")
...
ggplot(df_sr_c_br_str, aes(x = CSLD, y = Fungi, color = siteID)) +
  geom_point() +
  stat_smooth(method = "lm", formula = y ~ x) +
  labs(x = "Carbon Stock Stand Dead [ton]", y = "Fungi obs. rich. [alpha div.]")
