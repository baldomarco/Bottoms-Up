...
# write excel
writexl::write_xlsx(BDV_recovery_filtered, "C:/iLand/2023/20230901_Bottoms_Up/20230914_plot_experiment/_project/output/BDV_recovery_data_all_V4.xlsx")
...
#------------------
BDV_recovery_data <- read_xlsx("C:/iLand/2023/20230901_Bottoms_Up/20230914_plot_experiment/_project/output/BDV_recovery_data_all_V4.xlsx")
BDV_recovery_data
...
recovery_years <- BDV_recovery_data %>%
  ...
  summarise(
    ...
    across(starts_with("%_above_"), ~ {
      recovery_year <- year[which(. >= 10)[1]]  # Find first year >=10%
...
# NEED TO OPEN A PDF WRITER AND GIVE IT THE ROOT, THE NAME, AND THE SIZE
dataroot <- "C:/iLand/2023/20230901_Bottoms_Up/20230914_plot_experiment/_project/output/"
pdf(paste0(dataroot, "BDV_recovery_V4.pdf"), height=9, width=16)
